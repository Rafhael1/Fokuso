...
export default function CookiesPolicy() {
    ...
    useEffect(() => {
        document.title = "Fokuso | Cookies Policy"
    })


  return (
    <Container>
        <Link to="/" > <img className="Logo" style={style} src={Logo} alt=""/></Link>
      ...
      <p>This Cookies Policy explains what Cookies are and how We use them. You should
        ...
        Cookies Policy has been created with the help of the
        <a href="https://www.termsfeed.com/cookies-policy-generator/" >Cookies Policy Generator</a>.</p>
      <p>Cookies do not typically contain any information that personally identifies a
      ...
      <p>We do not store sensitive personal information, such as mailing addresses,
        account passwords, etc. in the Cookies We use.</p>
      ...
      <ul>
        <li>
          ...
          or &quot;Our&quot; in this Cookies Policy) refers to Fokuso.</li>
        <li>
          <strong>Cookies</strong>
          means small files that are placed on Your computer, mobile device or any other
          device by a website, containing details of your browsing history on that website
          among its many uses.</li>
        <li>
          <strong>Website</strong>
          refers to Fokuso, accessible from
          <a href="https://fokuso.xyz"  >https://fokuso.xyz</a>
        </li>
        <li>
          <strong>You</strong>
          means the individual accessing or using the Website, or a company, or any legal
      ...
      <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies.
        Persistent Cookies remain on your personal computer or mobile device when You go
      ...
      <p>If You prefer to avoid the use of Cookies on the Website, first You must
      ...
      <p>If You do not accept Our Cookies, You may experience some inconvenience in
      ...
      <p>You can learn more about cookies here:
        <a href="https://www.termsfeed.com/blog/cookies/" >All About Cookies by TermsFeed</a>.</p>
      <h2>Contact Us</h2>
      <p>If you have any questions about this Cookies Policy, You can contact us:</p>
      <ul>
        <li>By email: rafamlf.2018@gmail.com</li>
      </ul>
    </Container>
  )
}
